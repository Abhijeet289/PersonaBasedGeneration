...
def loadDialogue(model, val_file, input_tensor, target_tensor, db_tensor):
    # Iterate over dialogue
    for idx, (usr, sys, db) in enumerate(zip(val_file['usr'], val_file['sys'], val_file['db'])):
        tensor = []
    ...
    return input_tensor, target_tensor, db_tensor
