...
def loadDialogue(model, val_file, input_tensor, target_tensor, senti_tensor):
    # Iterate over dialogue
    for idx, (usr, sys, senti) in enumerate(zip(val_file['usr'], val_file['sys'], val_file['sentiment'])):
        tensor = []
    ...
    return input_tensor, target_tensor, senti_tensor
