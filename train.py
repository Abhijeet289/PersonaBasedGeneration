...
def train(print_loss_total,print_act_total, print_grad_total, input_tensor, target_tensor, persona_tensor, name=None):
    ...
    loss, loss_acts, grad = model.train(input_tensor, input_lengths, target_tensor, target_lengths, persona_tensor, name)
...
def trainIters(model, n_epochs=10, args=args):
    ...
    for epoch in range(1, n_epochs + 1):
        ...
        for name in dials:
            ...
            print_loss_total, print_act_total, print_grad_total = train(print_loss_total, print_act_total, print_grad_total, input_tensor, target_tensor, persona_tensor)
            input_tensor = [];target_tensor = [];persona_tensor = [];
        ...
        for name, val_file in val_dials.items():
            ...
            proba, _, _ = model.forward(input_tensor, input_lengths, target_tensor, target_lengths, persona_tensor)
