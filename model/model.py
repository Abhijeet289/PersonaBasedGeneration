...
class Model(nn.Module):
    ...
    def build_model(self):
        ...
        self.policy = policy.DefaultPolicy(self.hid_size_pol, self.hid_size_enc, self.db_size).to(self.device)
    ...
    def train(self, input_tensor, input_lengths, target_tensor, target_lengths, db_tensor, dial_name=None):
    ...
    def forward(self, input_tensor, input_lengths, target_tensor, target_lengths, db_tensor):
    ...
    def predict(self, input_tensor, input_lengths, target_tensor, target_lengths, db_tensor):
        with torch.no_grad():
            # ENCODER
            encoder_outputs, encoder_hidden = self.encoder(input_tensor, input_lengths)
