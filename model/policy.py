...
class DefaultPolicy(nn.Module):
    def __init__(self, hidden_size_pol, hidden_size, senti_size):
    ...
    def forward(self, encodings, senti_tensor, act_tensor=None):
        ...
        # Network based
        output = self.W_u(hidden[0]) + self.W_senti(senti_tensor)
